package ru.academits.agishev.education.vector.vectorOperations;

import ru.academits.agishev.education.vector.vector.Vector;

import static ru.academits.agishev.education.vector.vector.Vector.difference;
import static ru.academits.agishev.education.vector.vector.Vector.scalarMultiplication;
import static ru.academits.agishev.education.vector.vector.Vector.sum;
...
public class VectorOperations {
    public static void main(String[] args) {
        ...
        double v9 = scalarMultiplication(v1, v3);
